...
class PsiRecord extends Migration
{
    ...
    public function up()
    {
        ...
        $this->forge->addUniqueKey(
            ['equipment_id', 'date', 'shift', 'operator_name', 'hourmeter_start', 'hourmeter_end', 'checking_part'],
            "uq_" . $this->table . '_idx'
        );
        $this->forge->addUniqueKey(
            ['date', 'shift', 'equipment_id', 'operator_name', 'hourmeter_start', 'hourmeter_end', 'checking_part'],
            'idx_psi_lookup'
        );
